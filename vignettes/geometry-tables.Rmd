...
With some reservation, I call this the **gris model**. 
...
- use nested tables, though see worked discussions on how to do this ...
...
First we need to explain the key differences between `ggplot2
