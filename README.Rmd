...
Spbabel provides simple tools to flip between Spatial and tidy forms of data. This package is to assist in the development of tools for spatial data in R. There is limited use for users directly, though see examples below. 
